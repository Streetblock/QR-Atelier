...
2D components and a barcode-faithful SVG renderer while reusing that PDF417
foundation. Its API, linear-component boundary, and reference coverage are documented in
