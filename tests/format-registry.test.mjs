...
test('registers QR and Data Matrix with isolated capabilities', () => {
  assert.deepEqual(formatRegistry.list().map((format) => format.id), ['qr', 'datamatrix'])
  assert.deepEqual(formatRegistry.defaults(), {})
